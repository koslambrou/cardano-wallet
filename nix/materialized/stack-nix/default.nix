  ...
  extras = hackage:
    {
      packages = {
        ...
        byron-spec-chain = ./.stack-to-nix.cache.21;
        cardano-crypto-wrapper = ./.stack-to-nix.cache.22;
        cardano-crypto-test = ./.stack-to-nix.cache.23;
        byron-spec-ledger = ./.stack-to-nix.cache.24;
        cardano-ledger-byron = ./.stack-to-nix.cache.25;
        cardano-ledger-byron-test = ./.stack-to-nix.cache.26;
        cardano-ledger-shelley = ./.stack-to-nix.cache.27;
        cardano-ledger-shelley-test = ./.stack-to-nix.cache.28;
        cardano-ledger-shelley-ma = ./.stack-to-nix.cache.29;
        cardano-ledger-shelley-ma-test = ./.stack-to-nix.cache.30;
        cardano-ledger-core = ./.stack-to-nix.cache.31;
        cardano-ledger-pretty = ./.stack-to-nix.cache.32;
        cardano-protocol-tpraos = ./.stack-to-nix.cache.33;
        cardano-data = ./.stack-to-nix.cache.34;
        vector-map = ./.stack-to-nix.cache.35;
        set-algebra = ./.stack-to-nix.cache.36;
        small-steps = ./.stack-to-nix.cache.37;
        small-steps-test = ./.stack-to-nix.cache.38;
        non-integral = ./.stack-to-nix.cache.39;
        cardano-api = ./.stack-to-nix.cache.40;
        cardano-git-rev = ./.stack-to-nix.cache.41;
        cardano-cli = ./.stack-to-nix.cache.42;
        cardano-node = ./.stack-to-nix.cache.43;
        cardano-node-chairman = ./.stack-to-nix.cache.44;
        trace-dispatcher = ./.stack-to-nix.cache.45;
        trace-resources = ./.stack-to-nix.cache.46;
        trace-forward = ./.stack-to-nix.cache.47;
        cardano-prelude = ./.stack-to-nix.cache.48;
        cardano-prelude-test = ./.stack-to-nix.cache.49;
        cardano-sl-x509 = ./.stack-to-nix.cache.50;
        flat = ./.stack-to-nix.cache.51;
        goblins = ./.stack-to-nix.cache.52;
        hedgehog-extras = ./.stack-to-nix.cache.53;
        purescript-bridge = ./.stack-to-nix.cache.54;
        ...
        ekg-forward = ./.stack-to-nix.cache.63;
        cardano-config = ./.stack-to-nix.cache.64;
        monoidal-synchronisation = ./.stack-to-nix.cache.65;
        network-mux = ./.stack-to-nix.cache.66;
        ouroboros-consensus = ./.stack-to-nix.cache.67;
        ouroboros-consensus-test = ./.stack-to-nix.cache.68;
        ouroboros-consensus-byron = ./.stack-to-nix.cache.69;
        ouroboros-consensus-byronspec = ./.stack-to-nix.cache.70;
        ouroboros-consensus-byron-test = ./.stack-to-nix.cache.71;
        ouroboros-consensus-protocol = ./.stack-to-nix.cache.72;
        ouroboros-consensus-shelley = ./.stack-to-nix.cache.73;
        ouroboros-consensus-shelley-test = ./.stack-to-nix.cache.74;
        ouroboros-consensus-cardano = ./.stack-to-nix.cache.75;
        ouroboros-consensus-cardano-test = ./.stack-to-nix.cache.76;
        ouroboros-network = ./.stack-to-nix.cache.77;
        ouroboros-network-framework = ./.stack-to-nix.cache.78;
        ouroboros-network-testing = ./.stack-to-nix.cache.79;
        cardano-client = ./.stack-to-nix.cache.80;
        ntp-client = ./.stack-to-nix.cache.81;
        ouroboros-consensus-mock = ./.stack-to-nix.cache.82;
        io-classes = ./.stack-to-nix.cache.83;
        io-sim = ./.stack-to-nix.cache.84;
        strict-stm = ./.stack-to-nix.cache.85;
        typed-protocols = ./.stack-to-nix.cache.86;
        typed-protocols-cborg = ./.stack-to-nix.cache.87;
        typed-protocols-examples = ./.stack-to-nix.cache.88;
        plutus-core = ./.stack-to-nix.cache.89;
        plutus-ledger-api = ./.stack-to-nix.cache.90;
        plutus-tx = ./.stack-to-nix.cache.91;
        plutus-tx-plugin = ./.stack-to-nix.cache.92;
        plutus-ghc-stub = ./.stack-to-nix.cache.93;
        prettyprinter-configurable = ./.stack-to-nix.cache.94;
        word-array = ./.stack-to-nix.cache.95;
        servant-purescript = ./.stack-to-nix.cache.96;
        Win32-network = ./.stack-to-nix.cache.97;
        ekg-json = ./.stack-to-nix.cache.98;
        hw-aeson = ./.stack-to-nix.cache.99;
        };
