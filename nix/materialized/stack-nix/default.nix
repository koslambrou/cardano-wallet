  ...
  extras = hackage:
    {
      packages = {
        ...
        purescript-bridge = ./.stack-to-nix.cache.52;
        contra-tracer = ./.stack-to-nix.cache.53;
        iohk-monitoring = ./.stack-to-nix.cache.54;
        lobemo-backend-aggregation = ./.stack-to-nix.cache.55;
        lobemo-backend-ekg = ./.stack-to-nix.cache.56;
        lobemo-backend-monitoring = ./.stack-to-nix.cache.57;
        lobemo-backend-trace-forwarder = ./.stack-to-nix.cache.58;
        lobemo-scribe-systemd = ./.stack-to-nix.cache.59;
        tracer-transformers = ./.stack-to-nix.cache.60;
        ...
        ekg-json = ./.stack-to-nix.cache.95;
        hw-aeson = ./.stack-to-nix.cache.96;
        };
